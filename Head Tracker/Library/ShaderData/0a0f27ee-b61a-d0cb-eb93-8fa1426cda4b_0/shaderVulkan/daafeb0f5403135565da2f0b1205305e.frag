...
void main()
{
    ...
    vec3 _3669 = normalize(_u_WorldSpaceCameraPos.xyz - v_posWS);
    vec3 _12852;
    ...
    vec3 _3762 = pow(max(__AlbedoColor.xyz, vec3(9.9999997473787516355514526367188e-06)), vec3(2.2000000476837158203125));
    float _3766 = clamp(__Metallic, 0.0, 1.0);
    float _3702 = clamp(__Roughness, 0.0, 1.0);
    ...
    float _4081 = (((_4068 < 0.0) ? (-1.0) : 1.0) * _12855 + (-1.57079637050628662109375)) * 0.15915493667125701904296875 + __EnvRot;
    ...
    vec3 _4006 = ((_3716 * ((_4462.xyz / vec3(_4462.w)) * __Env)) * max(vec3(1.0), ((((((_3716 * 2.040400028228759765625) - vec3(0.3323999941349029541015625)) * 1.0) + ((_3716 * (-4.79510021209716796875)) + vec3(0.6417000293731689453125))) * 1.0) + ((_3716 * 2.755199909210205078125) + vec3(0.69029998779296875))) * 1.0)) * 1.0;
    ...
    float _4583 = (((_4570 < 0.0) ? (-1.0) : 1.0) * _12881 + (-1.57079637050628662109375)) * 0.15915493667125701904296875 + __EnvRot;
    ...
    vec3 _4013 = ((((_3745 * _5011.x) + vec3(_5011.y * clamp(50.0 * _3745.y, 0.0, 1.0))) * max(vec3(1.0), ((((((_3745 * 2.040400028228759765625) - vec3(0.3323999941349029541015625)) * 1.0) + ((_3745 * (-4.79510021209716796875)) + vec3(0.6417000293731689453125))) * 1.0) + ((_3745 * 2.755199909210205078125) + vec3(0.69029998779296875))) * 1.0)) * ((_4964.xyz / vec3(_4964.w)) * __Env)) * 1.0;
    vec3 _5075 = normalize(-_u_DirLightsDirection[0].xyz);
    float _5089 = (_u_DirLightsIntensity[0] * _u_DirLightsEnabled[0]) * 3.1415920257568359375;
    ...
    if (_u_DirLightsEnabled[0] > 0.5)
    {
        ...
        _13119 = _4013 + ((((((_3745 + ((vec3(1.0) - _3745) * ((_5282 * _5282) * _5268))) * (((_3776 * 0.31830990314483642578125) / (_5323 * _5323 + 1.0000000116860974230803549289703e-07)) * (0.5 / ((_3771 * (_3727 * _5295 + _5117) + (_3727 * (_3771 * _5295 + _5117))) + 9.9999997473787516355514526367188e-06)))) * _5117) * _u_DirLightsColor[0].xyz) * _5089) * 1.0);
        _13118 = _4006 + ((((_3716 * _u_DirLightsColor[0].xyz) * _5089) * (_5117 * 0.31830990314483642578125)) * 1.0);
    }
    else
    {
        _13119 = _4013;
    ...
    vec3 _5343 = normalize(-_u_DirLightsDirection[1].xyz);
    float _5357 = (_u_DirLightsIntensity[1] * _u_DirLightsEnabled[1]) * 3.1415920257568359375;
    ...
    if (_u_DirLightsEnabled[1] > 0.5)
    {
        ...
        _13319 = _13119 + ((((((_3745 + ((vec3(1.0) - _3745) * ((_5542 * _5542) * _5528))) * (((_3776 * 0.31830990314483642578125) / (_5560 * _5560 + 1.0000000116860974230803549289703e-07)) * 0.25)) * _5385) * _u_DirLightsColor[1].xyz) * _5357) * 1.0);
        _13318 = _13118 + ((((_3716 * _u_DirLightsColor[1].xyz) * _5357) * (_5385 * 0.31830990314483642578125)) * 1.0);
    }
    else
    {
        _13319 = _13119;
    ...
    vec3 _5580 = normalize(-_u_DirLightsDirection[2].xyz);
    float _5594 = (_u_DirLightsIntensity[2] * _u_DirLightsEnabled[2]) * 3.1415920257568359375;
    ...
    if (_u_DirLightsEnabled[2] > 0.5)
    {
        ...
        _13530 = _13319 + ((((((_3745 + ((vec3(1.0) - _3745) * ((_5779 * _5779) * _5765))) * (((_3776 * 0.31830990314483642578125) / (_5797 * _5797 + 1.0000000116860974230803549289703e-07)) * 0.25)) * _5622) * _u_DirLightsColor[2].xyz) * _5594) * 1.0);
        _13529 = _13318 + ((((_3716 * _u_DirLightsColor[2].xyz) * _5594) * (_5622 * 0.31830990314483642578125)) * 1.0);
    }
    else
    {
        _13530 = _13319;
    ...
    vec3 _5826 = _u_PointLightsPosition[0].xyz - v_posWS;
    float _5828 = length(_5826);
    vec3 _5832 = _5826 / vec3(_5828);
    float _5846 = (_u_PointLightsIntensity[0] * _u_PointLightsEnabled[0]) * 3.1415920257568359375;
    float _5853 = _5828 * _u_PointLightsAttenRangeInv[0];
    ...
    if (_u_PointLightsEnabled[0] > 0.5)
    {
        ...
        _13752 = _13530 + (((((((_3745 + ((vec3(1.0) - _3745) * ((_6082 * _6082) * _6068))) * (((_3776 * 0.31830990314483642578125) / (_6123 * _6123 + 1.0000000116860974230803549289703e-07)) * (0.5 / ((_3771 * (_3727 * _6095 + _5917) + (_3727 * (_3771 * _6095 + _5917))) + 9.9999997473787516355514526367188e-06)))) * _5917) * _u_PointLightsColor[0].xyz) * _5846) * _5867) * 1.0);
        _13751 = _13529 + (((((_3716 * _u_PointLightsColor[0].xyz) * _5846) * _5867) * (_5917 * 0.31830990314483642578125)) * 1.0);
    }
    else
    {
        _13752 = _13530;
    ...
    vec3 _6152 = _u_PointLightsPosition[1].xyz - v_posWS;
    float _6154 = length(_6152);
    vec3 _6158 = _6152 / vec3(_6154);
    float _6172 = (_u_PointLightsIntensity[1] * _u_PointLightsEnabled[1]) * 3.1415920257568359375;
    float _6179 = _6154 * _u_PointLightsAttenRangeInv[1];
    ...
    if (_u_PointLightsEnabled[1] > 0.5)
    {
        ...
        _13985 = _13752 + (((((((_3745 + ((vec3(1.0) - _3745) * ((_6400 * _6400) * _6386))) * (((_3776 * 0.31830990314483642578125) / (_6418 * _6418 + 1.0000000116860974230803549289703e-07)) * 0.25)) * _6243) * _u_PointLightsColor[1].xyz) * _6172) * _6193) * 1.0);
        _13984 = _13751 + (((((_3716 * _u_PointLightsColor[1].xyz) * _6172) * _6193) * (_6243 * 0.31830990314483642578125)) * 1.0);
    }
    else
    {
        _13985 = _13752;
    ...
    vec3 _6449 = _u_SpotLightsPosition[0].xyz - v_posWS;
    float _6451 = length(_6449);
    vec3 _6455 = _6449 / vec3(_6451);
    float _6469 = (_u_SpotLightsIntensity[0] * _u_SpotLightsEnabled[0]) * 3.1415920257568359375;
    float _6476 = _6451 * _u_SpotLightsAttenRangeInv[0];
    float _6523 = _6476 * _6476;
    float _6530 = clamp((-_6523) * _6523 + 1.0, 0.0, 1.0);
    vec3 _6511 = vec3((((_6530 * _6530) * (_6476 * _6476 + 1.0)) * 0.25) * smoothstep(_u_SpotLightsOuterAngleCos[0], _u_SpotLightsInnerAngleCos[0], max(0.0, dot(_6455, normalize(-_u_SpotLightsDirection[0].xyz)))));
    ...
    if (_u_SpotLightsEnabled[0] > 0.5)
    {
        ...
        _14229 = _13985 + (((((((_3745 + ((vec3(1.0) - _3745) * ((_6726 * _6726) * _6712))) * (((_3776 * 0.31830990314483642578125) / (_6767 * _6767 + 1.0000000116860974230803549289703e-07)) * (0.5 / ((_3771 * (_3727 * _6739 + _6561) + (_3727 * (_3771 * _6739 + _6561))) + 9.9999997473787516355514526367188e-06)))) * _6561) * _u_SpotLightsColor[0].xyz) * _6469) * _6511) * 1.0);
        _14228 = _13984 + (((((_3716 * _u_SpotLightsColor[0].xyz) * _6469) * _6511) * (_6561 * 0.31830990314483642578125)) * 1.0);
    }
    else
    {
        _14229 = _13985;
    ...
    vec3 _6798 = _u_SpotLightsPosition[1].xyz - v_posWS;
    float _6800 = length(_6798);
    vec3 _6804 = _6798 / vec3(_6800);
    float _6818 = (_u_SpotLightsIntensity[1] * _u_SpotLightsEnabled[1]) * 3.1415920257568359375;
    float _6825 = _6800 * _u_SpotLightsAttenRangeInv[1];
    float _6872 = _6825 * _6825;
    float _6879 = clamp((-_6872) * _6872 + 1.0, 0.0, 1.0);
    vec3 _6860 = vec3((((_6879 * _6879) * (_6825 * _6825 + 1.0)) * 0.25) * smoothstep(_u_SpotLightsOuterAngleCos[1], _u_SpotLightsInnerAngleCos[1], max(0.0, dot(_6804, normalize(-_u_SpotLightsDirection[1].xyz)))));
    ...
    if (_u_SpotLightsEnabled[1] > 0.5)
    {
        ...
        _14484 = _14229 + (((((((_3745 + ((vec3(1.0) - _3745) * ((_7067 * _7067) * _7053))) * (((_3776 * 0.31830990314483642578125) / (_7085 * _7085 + 1.0000000116860974230803549289703e-07)) * 0.25)) * _6910) * _u_SpotLightsColor[1].xyz) * _6818) * _6860) * 1.0);
        _14483 = _14228 + (((((_3716 * _u_SpotLightsColor[1].xyz) * _6818) * _6860) * (_6910 * 0.31830990314483642578125)) * 1.0);
    }
    else
    {
        _14484 = _14229;
    ...
    float _7115 = (_u_AreaLightsIntensity[0] * _u_AreaLightsEnabled[0]) * 3.1415920257568359375;
    vec3 _15245;
    vec3 _15286;
    if (_u_AreaLightsEnabled[0] > 0.5)
    {
        ...
        do
        {
            ...
            _7282 = _u_AreaLightsShape[0] > 0.5;
            if (_7282)
            {
                mat3 _7301 = transpose(mat3(_7275, _7279, _12852));
                vec3 _7308 = _7301 * (_u_AreaLightsPoint0[0].xyz - v_posWS);
                vec3 _7316 = _7301 * (_u_AreaLightsPoint1[0].xyz - v_posWS);
                vec3 _7324 = _7301 * (_u_AreaLightsPoint2[0].xyz - v_posWS);
            ...
            else
            {
                ...
                vec3 _7674 = _7667 * (_u_AreaLightsPoint0[0].xyz - v_posWS);
                vec3 _7682 = _7667 * (_u_AreaLightsPoint1[0].xyz - v_posWS);
                vec3 _7690 = _7667 * (_u_AreaLightsPoint2[0].xyz - v_posWS);
                vec3 _7698 = _7667 * (_u_AreaLightsPoint3[0].xyz - v_posWS);
                float _8084 = _7674.z;
        ...
        do
        {
            if (_7282)
            {
                ...
                vec3 _9037 = _9030 * (_u_AreaLightsPoint0[0].xyz - v_posWS);
                vec3 _9045 = _9030 * (_u_AreaLightsPoint1[0].xyz - v_posWS);
                vec3 _9053 = _9030 * (_u_AreaLightsPoint2[0].xyz - v_posWS);
            ...
            else
            {
                ...
                vec3 _9403 = _9396 * (_u_AreaLightsPoint0[0].xyz - v_posWS);
                vec3 _9411 = _9396 * (_u_AreaLightsPoint1[0].xyz - v_posWS);
                vec3 _9419 = _9396 * (_u_AreaLightsPoint2[0].xyz - v_posWS);
                vec3 _9427 = _9396 * (_u_AreaLightsPoint3[0].xyz - v_posWS);
                float _9813 = _9403.z;
        ...
        _15286 = _14484 + (((_u_AreaLightsColor[0].xyz * _7115) * (((_3745 * _8928.x) + ((vec3(1.0) - _3745) * _8928.y)) * _15152)) * 1.0);
        _15245 = _14483 + ((((_3716 * _u_AreaLightsColor[0].xyz) * _7115) * _14838) * 1.0);
    }
    else
    {
        _15286 = _14484;
    ...
    float _10564 = (_u_AreaLightsIntensity[1] * _u_AreaLightsEnabled[1]) * 3.1415920257568359375;
    vec3 _15812;
    vec3 _15813;
    if (_u_AreaLightsEnabled[1] > 0.5)
    {
        ...
        _15813 = _15286 + (((((_3745 + ((vec3(1.0) - _3745) * ((_10731 * _10731) * _10717))) * (((_3776 * 0.31830990314483642578125) / (_10749 * _10749 + 1.0000000116860974230803549289703e-07)) * 0.25)) * _12935) * _u_AreaLightsColor[1].xyz) * _10564);
        _15812 = _15245 + (((_3716 * _u_AreaLightsColor[1].xyz) * _10564) * (_12935 * 0.31830990314483642578125));
    }
    else
    {
        _15813 = _15286;
    ...
    o_fragColor = vec4(pow(max(_15812 + _15813, vec3(9.9999997473787516355514526367188e-06)), vec3(0.4545454680919647216796875)), __AlbedoColor.w);
}
